...
def setup(core, object):
	...
	object.setStfName('item_bracelet_l_set_commando_utility_a_01_01')
	object.setDetailFilename('static_item_d')
	object.setDetailName('item_bracelet_l_set_commando_utility_a_01_01')
	...
	object.setIntAttribute('cat_stat_mod_bonus.@stat_n:expertise_block_chance', 2)
	object.setIntAttribute('cat_stat_mod_bonus.@stat_n:combat_block_value', 50)
