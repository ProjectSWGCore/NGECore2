...
def addPlanetSpawns(core, planet):
	...
	stcSvc.spawnObject('juveline_canyon_krayt_dragon', 'tatooine', long(0), float(-4521.2), float(27.1), float(-4298.1), float(0), float(0), float(0), float(0), 1500)	
	...
	stcSvc.spawnObject('ancient_krayt_dragon', 'tatooine', long(0), float(-4713.3), float(46.5), float(-4288.3), float(0), float(0), float(0), float(0), 1800)	
