...
def addPlanetSpawns(core, planet):
	...
	shinn_guard = stcSvc.spawnObject('shinn_guard', 'tatooine', Building.getCellByCellNumber(long(2)), float(-3.3), float(0.3), float(3.6), float(0), float(0), float(0), float(0), 30)
