...
def addPlanetSpawns(core, planet):
	...
	shinn_guard = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124075), float(-3.3), float(0.3), float(3.6), float(0), float(0), float(0), float(0), 30)
	shinn_guard1 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124075), float(-3.3), float(0.3), float(-4.1), float(0), float(0), float(0), float(0), 30)
	shinn_guard2 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124085), float(3.7), float(-3.3), float(5.2), float(0), float(0), float(0), float(0), 30)
	shinn_guard3 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124093), float(-4.3), float(-10.3), float(-6.2), float(0), float(0), float(0), float(0), 30)
	shinn_guard4 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124123), float(4.3), float(-13.8), float(6.9), float(0), float(0), float(0), float(0), 30)
	shinn_guard5 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124123), float(-2.1), float(-13.8), float(6.8), float(0), float(0), float(0), float(0), 30)
	shinn_guard6 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124123), float(-6.8), float(-13.8), float(6.7), float(0), float(0), float(0), float(0), 30)
	shinn_guard7 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124141), float(1.5), float(-20.8), float(-3.5), float(0), float(0), float(0), float(0), 30)	
	shinn_guard8 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124142), float(-1.0), float(-20.7), float(11.0), float(0), float(0), float(0), float(0), 30)
	shinn_guard9 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124142), float(3.6), float(-20.7), float(11.4), float(0), float(0), float(0), float(0), 30)
	shinn_guard10 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124142), float(1.6), float(-20.7), float(4.7), float(0), float(0), float(0), float(0), 30)
	shinn_guard11 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124152), float(-1.6), float(-20.8), float(23.4), float(0), float(0), float(0), float(0), 30)
	shinn_guard12 = stcSvc.spawnObject('shinn_guard', 'tatooine', long(15124152), float(4.6), float(-20.8), float(23.4), float(0), float(0), float(0), float(0), 30)
	
	# Vaigonn Shinn				
	vaigonn_shinn = stcSvc.spawnObject('vaigon_shinn', 'tatooine', long(15124152), float(1.7), float(-20.8), float(29.7), float(-1), float(0), float(0), float(0), 30)
