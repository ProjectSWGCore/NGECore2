...
def addPlanetSpawns(core, planet):
	...
	carrion_kreetle15 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3559), float(4), float(-5061), float(0), float(0), float(0), float(0), 30)	
	carrion_kreetle16 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3562), float(4), float(-5064), float(0), float(0), float(0), float(0), 30)	
	carrion_kreetle17 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3565), float(4), float(-5058), float(0), float(0), float(0), float(0), 30)	
	carrion_kreetle18 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3535), float(4), float(-5061), float(0), float(0), float(0), float(0), 30)	
	carrion_kreetle19 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3551), float(4), float(-5058), float(0), float(0), float(0), float(0), 30)		
	...
	carrion_kreetle25 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3250), float(8), float(-4461), float(0), float(0), float(0), float(0), 30)	
	carrion_kreetle26 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3238), float(8), float(-4464), float(0), float(0), float(0), float(0), 30)	
	carrion_kreetle27 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3228), float(8), float(-4470), float(0), float(0), float(0), float(0), 30)	
	carrion_kreetle28 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3222), float(8), float(-4471), float(0), float(0), float(0), float(0), 30)	
	carrion_kreetle29 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3239), float(8), float(-4437), float(0), float(0), float(0), float(0), 30)		
	...
	carrion_kreetle33 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3157), float(4), float(-4840), float(0), float(0), float(0), float(0), 30)
	carrion_kreetle34 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3167), float(4), float(-4850), float(0), float(0), float(0), float(0), 30)
	...
	carrion_kreetle37 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3150), float(4), float(-4856), float(0), float(0), float(0), float(0), 30)
	carrion_kreetle38 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3163), float(4), float(-4844), float(0), float(0), float(0), float(0), 30)
	carrion_kreetle39 = stcSvc.spawnObject('carrion_kreetle', 'tatooine', long(0), float(3140), float(4), float(-4860), float(0), float(0), float(0), float(0), 30)
