...
def addPlanetSpawns(core, planet):
	...
	guard1.setOptionsBitmask(Options.INVULNERABLE)
	...
	guard2.setOptionsBitmask(Options.INVULNERABLE)
	guard3 = stcSvc.spawnObject('outbreak_imperial_stormtrooper_guards', 'dathomir', long(0), float(-5745), float(511), float(-6484), float(0.51), float(0.85))
	guard3.setOptionsBitmask(Options.INVULNERABLE)
	guard4 = stcSvc.spawnObject('outbreak_imperial_stormtrooper_guards', 'dathomir', long(0), float(-5744), float(511), float(-6480), float(0.51), float(0.85))
	guard4.setOptionsBitmask(Options.INVULNERABLE)
	...
	trooper1.setOptionsBitmask(Options.INVULNERABLE)
	...
	trooper2.setOptionsBitmask(Options.INVULNERABLE)
	...
	trooper3.setOptionsBitmask(Options.INVULNERABLE)
	...
	trooper4.setOptionsBitmask(Options.INVULNERABLE)
	...
	alphaguard1.setOptionsBitmask(Options.INVULNERABLE)
	...
	alphaguard2.setOptionsBitmask(Options.INVULNERABLE)
	...
	alphaguard3.setOptionsBitmask(Options.INVULNERABLE)
	...
	alphaguard4.setOptionsBitmask(Options.INVULNERABLE)
	alphaguard5 = stcSvc.spawnObject('outbreak_mixed_guard_aggro', 'dathomir', long(0), float(-5930), float(560), float(-6690), float(0.26), float(0.85))
	alphaguard5.setOptionsBitmask(Options.INVULNERABLE)
	...
	betaguard1.setOptionsBitmask(Options.INVULNERABLE)
	...
	betaguard2.setOptionsBitmask(Options.INVULNERABLE)
	...
	betaguard3.setOptionsBitmask(Options.INVULNERABLE)
	...
	betaguard4.setOptionsBitmask(Options.INVULNERABLE)
	...
	deltaguard1.setOptionsBitmask(Options.INVULNERABLE)
	...
	deltaguard2.setOptionsBitmask(Options.INVULNERABLE)
	...
	deltaguard3.setOptionsBitmask(Options.INVULNERABLE)
	...
	deltaguard4.setOptionsBitmask(Options.INVULNERABLE)
	...
	deltaguard5.setOptionsBitmask(Options.INVULNERABLE)
