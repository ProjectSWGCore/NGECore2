...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('savage_humbaba')
	...
	mobileTemplate.setMeatAmount(265)
	mobileTemplate.setHideType("Leathery Hide")
	mobileTemplate.setHideAmount(168)
	mobileTemplate.setBoneType("Animal Bones")
	mobileTemplate.setBoneAmount(118)
	...
	core.spawnService.addMobileTemplate('savage_humbaba', mobileTemplate)
	return