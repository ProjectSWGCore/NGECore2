...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('beldonnas_marshal')
	...
	templates.add('object/mobile/shared_dressed_mercenary_elite_hum_m_01.iff')
	...
	core.spawnService.addMobileTemplate('beldonnas_marshal', mobileTemplate)
	return