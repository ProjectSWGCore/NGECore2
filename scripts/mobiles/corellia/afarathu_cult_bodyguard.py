...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('afarathu_cult_bodyguard')
	...
	weapontemplate = WeaponTemplate('object/weapon/ranged/carbine/shared_carbine_e11.iff', WeaponType.RIFLE, 1.0, 15, 'energy')
	...
	core.spawnService.addMobileTemplate('afarathu_cult_bodyguard', mobileTemplate)
	return