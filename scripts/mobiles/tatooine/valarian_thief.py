...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('valarian_thief')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_tatooine_valarian_thief.iff')
	...
	core.spawnService.addMobileTemplate('valarian_thief', mobileTemplate)
	return