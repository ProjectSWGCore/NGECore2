...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('jabba_assassin')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_tatooine_jabba_assassin.iff')
	...
	core.spawnService.addMobileTemplate('smuggler_patrol_bh_1', mobileTemplate)
	return