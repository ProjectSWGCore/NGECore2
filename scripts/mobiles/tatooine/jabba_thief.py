...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('jabba_thief')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_tatooine_jabba_thief.iff')
	...
	core.spawnService.addMobileTemplate('jabba_thief', mobileTemplate)
	return