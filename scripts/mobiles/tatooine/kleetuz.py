...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('tatooine_repo_kleetuz')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_tatooine_repo_kleetuz.iff')
	...
	core.spawnService.addMobileTemplate('kleetuz', mobileTemplate)
	return