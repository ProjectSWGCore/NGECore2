...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('tatooine_opening_dren')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_tatooine_opening_dren.iff')
	...
	core.spawnService.addMobileTemplate('durr_rodak', mobileTemplate)
	return