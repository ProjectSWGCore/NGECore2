...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('legacy_ra_droid')
	...
	templates = Vector()
	templates.add('object/mobile/shared_protocol_droid.iff')
	...
	core.spawnService.addMobileTemplate('ra316', mobileTemplate)
	return