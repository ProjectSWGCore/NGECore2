...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('mission_pirate')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_pirate_plunderer_of_tatooine.iff')
	...
	core.spawnService.addMobileTemplate('pirate', mobileTemplate)
	return