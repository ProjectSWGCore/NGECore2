...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('evil_settler')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_tatooine_evil_settler.iff')
	...
	core.spawnService.addMobileTemplate('evil_settler', mobileTemplate)
	return