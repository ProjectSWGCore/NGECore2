...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('peko_peko_albatross_high')
	...
	templates = Vector()
	templates.add('object/mobile/shared_peko_peko_hue.iff')
	...
	core.spawnService.addMobileTemplate('peko_peko_albatross_high', mobileTemplate)
	return