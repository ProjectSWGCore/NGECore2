...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('woolamander_harrower')			
	...
	mobileTemplate.setAssistRange(40)
	...
	core.spawnService.addMobileTemplate('woolamander_harrower', mobileTemplate)
	return