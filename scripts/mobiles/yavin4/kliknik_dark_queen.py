...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('kliknik_dark_queen')
	...
	templates = Vector()
	templates.add('object/mobile/shared_kliknik_queen.iff')
	...
	core.spawnService.addMobileTemplate('kliknik_dark_queen', mobileTemplate)
	return