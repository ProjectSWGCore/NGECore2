...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('mawgax_youth')			
	...
	templates = Vector()
	templates.add('object/mobile/shared_mawgax_youth.iff')
	...
	core.spawnService.addMobileTemplate('mawgax_youth', mobileTemplate)
	return