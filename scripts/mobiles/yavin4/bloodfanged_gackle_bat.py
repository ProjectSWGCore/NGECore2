...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('bloodfanged_gackle_bat')
	...
	templates = Vector()
	templates.add('object/mobile/shared_gackle.iff')
	...
	core.spawnService.addMobileTemplate('bloodfanged_gackle_bat', mobileTemplate)
	return