...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('stranded_rebel_soldier')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_stranded_rebel_soldier.iff')
	...
	core.spawnService.addMobileTemplate('stranded_rebel_soldier', mobileTemplate)
	return