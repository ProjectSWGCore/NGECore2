...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('puny_tanc_mite')			
	...
	templates = Vector()
	templates.add('object/mobile/shared_puny_tanc_mite.iff')
	...
	core.spawnService.addMobileTemplate('puny_tanc_mite', mobileTemplate)
	return