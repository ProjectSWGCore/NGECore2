...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('stranded_rebel_pilot')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_stranded_rebel_pilot.iff')
	...
	core.spawnService.addMobileTemplate('stranded_rebel_pilot', mobileTemplate)
	return