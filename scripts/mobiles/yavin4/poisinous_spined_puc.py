...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('spined_puc_poison')			
	...
	templates = Vector()
	templates.add('object/mobile/shared_spined_puc.iff')
	...
	core.spawnService.addMobileTemplate('poisinous_spined_puc', mobileTemplate)
	return