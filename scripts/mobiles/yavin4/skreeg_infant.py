...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('skreeg_infant')			
	...
	templates = Vector()
	templates.add('object/mobile/shared_skreeg_infant.iff')
	...
	core.spawnService.addMobileTemplate('skreeg_infant', mobileTemplate)
	return