...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('giant_mawgax')			
	...
	templates = Vector()
	templates.add('object/mobile/shared_giant_mawgax.iff')
	...
	core.spawnService.addMobileTemplate('giant_mawgax', mobileTemplate)
	return