...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('whisper_bird_hatchling')			
	...
	templates = Vector()
	templates.add('object/mobile/shared_whisper_bird_hatchling.iff')
	...
	core.spawnService.addMobileTemplate('whisper_bird_hatchling', mobileTemplate)
	return