...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('fed_dub_captain')
	...
	templates.add('object/mobile/shared_dressed_fed_dub_captain_twk_female_01.iff')
	...
	core.spawnService.addMobileTemplate('fed_dub_captain', mobileTemplate)
	return