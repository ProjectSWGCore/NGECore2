...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('fed_dub_investigator')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_fed_dub_investigator_twk_male_01.iff')
	...
	core.spawnService.addMobileTemplate('fed_dub_investigator', mobileTemplate)
	return