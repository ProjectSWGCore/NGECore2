...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('liberation_fanatic')
	...
	templates.add('object/mobile/shared_dressed_liberation_fanatic_bith_male_01.iff')
	...
	core.spawnService.addMobileTemplate('liberation_fanatic', mobileTemplate)
	return