...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('fed_dub_supporter')
	...
	templates.add('object/mobile/shared_dressed_fed_dub_supporter_human_female_01.iff')
	...
	core.spawnService.addMobileTemplate('fed_dub_supporter', mobileTemplate)
	return