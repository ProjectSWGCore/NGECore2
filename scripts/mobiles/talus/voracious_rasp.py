...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('voracious_rasp')
	...
	mobileTemplate.setSocialGroup("voracious rasp")
	...
	core.spawnService.addMobileTemplate('voracious_rasp', mobileTemplate)
	return