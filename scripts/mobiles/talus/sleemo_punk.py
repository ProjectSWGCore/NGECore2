...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('sleemo_punk')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_talus_sif_mercenary_trand_01.iff')
	...
	core.spawnService.addMobileTemplate('sleemo_punk', mobileTemplate)
	return