...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('aakuan_steward')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_aakuan_steward_human_male_01.iff')
	templates.add('object/mobile/shared_dressed_aakuan_steward_human_female_01.iff')
