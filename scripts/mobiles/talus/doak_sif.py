...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('doak_sif')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_doak_sif.iff')
	...
	core.spawnService.addMobileTemplate('doak_sif', mobileTemplate)
	return