...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('wood_mite_matriarch')
	...
	templates = Vector()
	templates.add('object/mobile/shared_wood_mite_matriarch.iff')
	...
	core.spawnService.addMobileTemplate('wood_mite_matriarch', mobileTemplate)
	return