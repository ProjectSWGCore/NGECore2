...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('vrobal_bull')
	...
	templates = Vector()
	templates.add('object/mobile/shared_vrobal_bull.iff')
	...
	core.spawnService.addMobileTemplate('vrobal_bull', mobileTemplate)
	return