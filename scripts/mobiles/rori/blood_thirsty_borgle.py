...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('blood thirsty borgle')
	...
	templates = Vector()
	templates.add('object/mobile/shared_borgle_hue.iff')
	...
	core.spawnService.addMobileTemplate('blood_thirsty_borgle', mobileTemplate)
	return