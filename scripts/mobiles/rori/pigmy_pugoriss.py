...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('pigmy_pugoriss')
	...
	templates = Vector()
	templates.add('object/mobile/shared_pigmy_pugoriss.iff')
	...
	core.spawnService.addMobileTemplate('pigmy_pugoriss', mobileTemplate)
	return