...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('domestic_bearded_jax')
	...
	mobileTemplate.setSocialGroup("narmle")
	...
	core.spawnService.addMobileTemplate('domestic_bearded_jax', mobileTemplate)
	return