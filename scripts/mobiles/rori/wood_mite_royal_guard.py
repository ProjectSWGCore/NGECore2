...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('wood_mite_royal_guard')
	...
	templates = Vector()
	templates.add('object/mobile/shared_wood_mite.iff')
	...
	core.spawnService.addMobileTemplate('wood_mite_royal_guard', mobileTemplate)
	return