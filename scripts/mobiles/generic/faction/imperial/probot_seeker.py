...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('imperial_probot_drone')
	...
	templates = Vector()
	templates.add('object/mobile/shared_probot.iff')
	...
	core.spawnService.addMobileTemplate('probot_seeker', mobileTemplate)
	return