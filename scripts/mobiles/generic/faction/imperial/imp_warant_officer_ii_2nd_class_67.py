...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('crackdown_imperial_warrant_officer_ii')
	...
	core.spawnService.addMobileTemplate('imp_warrant_offi_2nd_class_ii_67', mobileTemplate)
	return