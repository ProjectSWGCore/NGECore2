...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('lesser_prophet_of_the_dark_side')
	...
	templates.add('object/mobile/shared_dressed_dark_jedi_human_male_01.iff')
	...
	core.spawnService.addMobileTemplate('lesser_prophet_dark_side', mobileTemplate)
	return