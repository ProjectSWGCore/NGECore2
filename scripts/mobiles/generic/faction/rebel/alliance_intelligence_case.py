...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('mission_alliance_intelligence_case_officer')
	...
	core.spawnService.addMobileTemplate('alliance_intelligence_case', mobileTemplate)
	return