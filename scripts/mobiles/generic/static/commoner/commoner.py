...
def addTemplate(core):
	...
	mobileTemplate.setCustomName('a Commoner')
	...
	templates.add('object/mobile/shared_dressed_commoner_naboo_human_male_06.iff')
	templates.add('object/mobile/shared_dressed_commoner_naboo_moncal_male_01.iff')
	templates.add('object/mobile/shared_dressed_commoner_naboo_zabrak_female_02.iff')
	...
	core.spawnService.addMobileTemplate('commoner', mobileTemplate)
	return