...
def addTemplate(core):
	...
	mobileTemplate.setCustomName('a Noble')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_noble_trandoshan_male_01.iff')
	...
	core.spawnService.addMobileTemplate('noble', mobileTemplate)
	return