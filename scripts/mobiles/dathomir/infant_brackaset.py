...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('infant_brackaset')
	...
	templates = Vector()
	templates.add('object/mobile/shared_infant_brackaset.iff')
	...
	core.spawnService.addMobileTemplate('infant_brackaset', mobileTemplate)
	return