...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('singing_mtn_clan_rancor_tamer')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_dathomir_sing_mt_clan_rancor_tamer.iff')
	...
	core.spawnService.addMobileTemplate('singing_mtn_clan_rancor_tamer', mobileTemplate)