...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('singing_mtn_clan_guardian')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_dathomir_sing_mt_clan_guardian.iff')
	...
	core.spawnService.addMobileTemplate('singing_mtn_clan_guardian', mobileTemplate)