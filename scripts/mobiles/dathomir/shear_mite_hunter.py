...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('shear_mite_hunter')
	...
	templates = Vector()
	templates.add('object/mobile/shared_shear_mite_hunter.iff')
	...
	core.spawnService.addMobileTemplate('shear_mite_hunter', mobileTemplate)
	return