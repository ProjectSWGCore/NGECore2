...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('singing_mtn_clan_dragoon')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_dathomir_sing_mt_clan_dragoon.iff')
	...
	core.spawnService.addMobileTemplate('singing_mtn_clan_dragoon', mobileTemplate)