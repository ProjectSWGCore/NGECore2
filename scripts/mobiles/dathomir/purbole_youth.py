...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('purbole_youth')
	...
	templates = Vector()
	templates.add('object/mobile/shared_purbole_youth.iff')
	...
	core.spawnService.addMobileTemplate('purbole_youth', mobileTemplate)