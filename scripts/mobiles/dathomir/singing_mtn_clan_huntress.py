...
def addTemplate(core):
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_dathomir_sing_mt_clan_huntress.iff')
	...
	core.spawnService.addMobileTemplate('singing_mtn_clan_huntress', mobileTemplate)