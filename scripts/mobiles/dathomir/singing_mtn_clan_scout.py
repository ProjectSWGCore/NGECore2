...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('singing_mtn_clan_scout')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_dathomir_sing_mt_clan_scout.iff')
	...
	core.spawnService.addMobileTemplate('singing_mtn_clan_scout', mobileTemplate)