...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('lurking_shear_mite')
	...
	templates = Vector()
	templates.add('object/mobile/shared_shear_mite.iff')
	...
	core.spawnService.addMobileTemplate('lurking_shear_mite', mobileTemplate)
	return