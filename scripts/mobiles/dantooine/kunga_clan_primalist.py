...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('kunga_clan_primalist')
	...
	mobileTemplate.setSocialGroup('kunga tribe')
	...
	core.spawnService.addMobileTemplate('kunga_clan_primalist', mobileTemplate)
