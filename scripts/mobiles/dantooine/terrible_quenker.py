...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('terrible_quenker')
	...
	templates = Vector()
	templates.add('object/mobile/shared_quenker.iff')
	...
	core.spawnService.addMobileTemplate('terrible_quenker', mobileTemplate)
	return