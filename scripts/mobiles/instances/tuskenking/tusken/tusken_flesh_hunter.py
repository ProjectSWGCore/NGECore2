...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('heroic_tusken_flesh_hunter')
	mobileTemplate.setLevel(91)
	...
	core.spawnService.addMobileTemplate('heroic_tusken_flesh_hunter', mobileTemplate)
	return