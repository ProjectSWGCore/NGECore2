...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('aged lantern bird')
	...
	templates = Vector()
	templates.add('object/mobile/shared_lantern_hue.iff')
	...
	core.spawnService.addMobileTemplate('aged_lantern_bird', mobileTemplate)
	return