...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('gnarled_donkuwah_spiritmaster')
	...
	weapontemplate = WeaponTemplate('object/weapon/melee/polearm/shared_lance_staff_janta.iff', 6, 1.0)
	weaponTemplates.add(weapontemplate)
	...
	core.spawnService.addMobileTemplate('gnarled_donkuwah_spiritmaster', mobileTemplate)
	return