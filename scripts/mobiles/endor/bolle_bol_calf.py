...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('bolle_bol_calf')
	...
	templates = Vector()
	templates.add('object/mobile/shared_bolle_bol_calf.iff')
	...
	core.spawnService.addMobileTemplate('bolle_bol_calf', mobileTemplate)
	return