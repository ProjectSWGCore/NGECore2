...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('radiant lantern bird')
	...
	templates = Vector()
	templates.add('object/mobile/shared_lantern_bird_hue.iff')
	...
	core.spawnService.addMobileTemplate('radiant_lantern_bird', mobileTemplate)
	return