...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('bolle bol herd leader')
	...
	templates = Vector()
	templates.add('object/mobile/shared_bolle_bol_hue.iff')
	...
	core.spawnService.addMobileTemplate('bolle_bol_herd_leader', mobileTemplate)
	return