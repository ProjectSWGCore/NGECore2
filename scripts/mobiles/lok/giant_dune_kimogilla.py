...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('giant_dune_kimogilla')
	...
	templates = Vector()
	templates.add('object/mobile/shared_giant_dune_kimogila.iff')
	...
	core.spawnService.addMobileTemplate('giant_dune_kimogilla', mobileTemplate)
	return