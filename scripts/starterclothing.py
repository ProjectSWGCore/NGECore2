...
def CreateStarterClothing(core, object, starterProfession, raceTemplate):
        ...
        if starterProfession == 'outdoors_scout' and raceTemplate == 'object/creature/player/human_male.iff':
				...
				core.scriptService.callScript("scripts/starter_clothing/", "outdoors_scout_humanoid_male", "OutdoorScoutHumanoidMale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "outdoors_scout_trandoshan_male", "OutdoorScoutTrandoshanMale", core, object)

        elif starterProfession == 'outdoors_scout' and raceTemplate == 'object/creature/player/trandoshan_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "outdoors_scout_trandoshan_female", "OutdoorScoutTrandoshanFemale", core, object)

        elif starterProfession == 'outdoors_scout' and raceTemplate == 'object/creature/player/wookiee_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "outdoors_scout_wookiee_male", "OutdoorScoutWookieeMale", core, object)

        elif starterProfession == 'outdoors_scout' and raceTemplate == 'object/creature/player/wookiee_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "outdoors_scout_wookiee_female", "OutdoorScoutWookieeFemale", core, object)
        
        elif starterProfession == 'outdoors_scout' and raceTemplate == 'object/creature/player/ithorian_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "outdoors_scout_ithorian_male", "OutdoorScoutIthorianMale", core, object)
  
        elif starterProfession == 'outdoors_scout' and raceTemplate == 'object/creature/player/ithorian_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "outdoors_scout_ithorian_female", "OutdoorScoutIthorianFemale", core, object)

        elif starterProfession == 'combat_brawler' and raceTemplate == 'object/creature/player/human_male.iff':
				core.scriptService.callScript("scripts/starter_clothing/", "combat_brawler_humanoid_male", "CombatBrawlerHumanoidMale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_brawler_humanoid_female", "CombatBrawlerHumanoidFemale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_brawler_trandoshan_male", "CombatBrawlerTrandoshanMale", core, object)

        elif starterProfession == 'combat_brawler' and raceTemplate == 'object/creature/player/trandoshan_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_brawler_trandoshan_female", "CombatBrawlerOutdoorScoutTrandoshanFemale", core, object)

        elif starterProfession == 'combat_brawler' and raceTemplate == 'object/creature/player/wookiee_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_brawler_wookiee_male", "CombatBrawlerWookieeMale", core, object)

        elif starterProfession == 'combat_brawler' and raceTemplate == 'object/creature/player/wookiee_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_brawler_wookiee_female", "CombatBrawlerWookieeFemale", core, object)
        
        elif starterProfession == 'combat_brawler' and raceTemplate == 'object/creature/player/ithorian_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_brawler_ithorian_male", "CombatBrawlerIthorianMale", core, object)
  
        elif starterProfession == 'combat_brawler' and raceTemplate == 'object/creature/player/ithorian_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_brawler_ithorian_female", "CombatBrawlerIthorianFemale", core, object)


        elif starterProfession == 'combat_marksman' and raceTemplate == 'object/creature/player/human_male.iff':
				core.scriptService.callScript("scripts/starter_clothing/", "combat_marksman_humanoid_male", "CombatMarksmanHumanoidMale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_marksman_humanoid_female", "CombatMarksmanHumanoidFemale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_marksman_trandoshan_male", "CombatMarksmanTrandoshanMale", core, object)

        elif starterProfession == 'combat_marksman' and raceTemplate == 'object/creature/player/trandoshan_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_marksman_trandoshan_female", "CombatMarksmanTrandoshanFemale", core, object)

        elif starterProfession == 'combat_marksman' and raceTemplate == 'object/creature/player/wookiee_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_marksman_wookiee_male", "CombatMarksmanWookieeMale", core, object)

        elif starterProfession == 'combat_marksman' and raceTemplate == 'object/creature/player/wookiee_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_marksman_wookiee_female", "CombatMarksmanWookieeFemale", core, object)
        
        elif starterProfession == 'combat_marksman' and raceTemplate == 'object/creature/player/ithorian_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_marksman_ithorian_male", "CombatMarksmanIthorianMale", core, object)
  
        elif starterProfession == 'combat_marksman' and raceTemplate == 'object/creature/player/ithorian_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "combat_marksman_ithorian_female", "CombatMarksmanIthorianFemale", core, object)

        elif starterProfession == 'crafting_artisan' and raceTemplate == 'object/creature/player/human_male.iff':
				core.scriptService.callScript("scripts/starter_clothing/", "crafting_artisan_humanoid_male", "CraftingArtisanHumanoidMale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "crafting_artisan_humanoid_female", "CraftingArtisanHumanoidFemale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "crafting_artisan_twilek_female", "CraftingArtisanTwilekFemale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "crafting_artisan_trandoshan_male", "CraftingArtisanTrandoshanMale", core, object)

        elif starterProfession == 'crafting_artisan' and raceTemplate == 'object/creature/player/trandoshan_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "crafting_artisan_trandoshan_female", "CraftingArtisanTrandoshanFemale", core, object)

        elif starterProfession == 'crafting_artisan' and raceTemplate == 'object/creature/player/wookiee_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "crafting_artisan_wookiee_male", "CraftingArtisanWookieeMale", core, object)

        elif starterProfession == 'crafting_artisan' and raceTemplate == 'object/creature/player/wookiee_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "crafting_artisan_wookiee_female", "CraftingArtisanWookieeFemale", core, object)
        
        elif starterProfession == 'crafting_artisan' and raceTemplate == 'object/creature/player/ithorian_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "crafting_artisan_ithorian_male", "CraftingArtisanIthorianMale", core, object)
  
        elif starterProfession == 'crafting_artisan' and raceTemplate == 'object/creature/player/ithorian_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "crafting_artisan_ithorian_female", "CraftingArtisanIthorianFemale", core, object)


        elif starterProfession == 'science_medic' and raceTemplate == 'object/creature/player/human_male.iff':
				core.scriptService.callScript("scripts/starter_clothing/", "science_medic_humanoid_male", "ScienceMedicHumanoidMale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "science_medic_humanoid_female", "ScienceMedicHumanoidFemale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "science_medic_trandoshan_male", "ScienceMedicTrandoshanMale", core, object)

        elif starterProfession == 'science_medic' and raceTemplate == 'object/creature/player/trandoshan_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "science_medic_trandoshan_female", "ScienceMedicTrandoshanFemale", core, object)

        elif starterProfession == 'science_medic' and raceTemplate == 'object/creature/player/wookiee_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "science_medic_wookiee_male", "ScienceMedicWookieeMale", core, object)

        elif starterProfession == 'science_medic' and raceTemplate == 'object/creature/player/wookiee_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "science_medic_wookiee_female", "ScienceMedicWookieeFemale", core, object)
        
        elif starterProfession == 'science_medic' and raceTemplate == 'object/creature/player/ithorian_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "science_medic_ithorian_male", "ScienceMedicIthorianMale", core, object)
  
        elif starterProfession == 'science_medic' and raceTemplate == 'object/creature/player/ithorian_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "science_medic_ithorian_female", "ScienceMedicIthorianFemale", core, object)



        elif starterProfession == 'social_entertainer' and raceTemplate == 'object/creature/player/human_male.iff':
				core.scriptService.callScript("scripts/starter_clothing/", "social_entertainer_humanoid_male", "SocialEntertainerHumanoidMale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "social_entertainer_humanoid_female", "SocialEntertainerHumanoi_female", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "social_entertainer_twilek_female", "SocialEntertainerTwilekFemale", core, object)
 				...
 				core.scriptService.callScript("scripts/starter_clothing/", "social_entertainer_trandoshan_male", "SocialEntertainerTrandoshanMale", core, object)

        elif starterProfession == 'social_entertainer' and raceTemplate == 'object/creature/player/trandoshan_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "social_entertainer_trandoshan_female", "SocialEntertainerTrandoshanFemale", core, object)

        elif starterProfession == 'social_entertainer' and raceTemplate == 'object/creature/player/wookiee_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "social_entertainer_wookiee_male", "SocialEntertainerWookieeMale", core, object)

        elif starterProfession == 'social_entertainer' and raceTemplate == 'object/creature/player/wookiee_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "social_entertainer_wookiee_female", "SocialEntertainerWookieeFemale", core, object)
        
        elif starterProfession == 'social_entertainer' and raceTemplate == 'object/creature/player/ithorian_male.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "social_entertainer_ithorian_male", "SocialEntertainerIthorianMale", core, object)
  
        elif starterProfession == 'social_entertainer' and raceTemplate == 'object/creature/player/ithorian_female.iff':
 				core.scriptService.callScript("scripts/starter_clothing/", "social_entertainer_ithorian_female", "SocialEntertainerIthorianFemale", core, object)
