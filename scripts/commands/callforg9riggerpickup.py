...
def run(core, actor, target, commandstring):
	...
	object = objSvc.createObject('object/tangible/terminal/shared_terminal_travel_instant_tcg_location.iff', actor.getPlanet(), (actor.getWorldPosition().x)+5, actor.getWorldPosition().z, actor.getWorldPosition().y)
