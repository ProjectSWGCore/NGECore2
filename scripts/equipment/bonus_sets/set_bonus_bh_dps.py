...
def handleChange(core, creature, set):
	...
	if wornItems == 3:
		...
		creature.sendSystemMessage('@set_bonus:set_bonus_bh_dps_1_sys', 0)
	elif wornItems == 4:
		core.buffService.addBuffToCreature(creature, "set_bonus_bh_dps_2", creature)
		creature.sendSystemMessage('@set_bonus:set_bonus_bh_dps_2_sys', 0)
	elif wornItems == 5:
		core.buffService.addBuffToCreature(creature, "set_bonus_bh_dps_3", creature)
		creature.sendSystemMessage('@set_bonus:set_bonus_bh_dps_3_sys', 0)
	else:
