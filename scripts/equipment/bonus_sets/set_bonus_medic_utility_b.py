...
def handleChange(core, creature, set):
	...
	if wornItems == 3:
		...
		creature.sendSystemMessage('@set_bonus:set_bonus_medic_utility_b_1_sys', 0)
	elif wornItems == 4:
		core.buffService.addBuffToCreature(creature, "set_bonus_medic_utility_b_2", creature)
		creature.sendSystemMessage('@set_bonus:set_bonus_medic_utility_b_2_sys', 0)
	elif wornItems == 5:
		core.buffService.addBuffToCreature(creature, "set_bonus_medic_utility_b_3", creature)
		creature.sendSystemMessage('@set_bonus:set_bonus_medic_utility_b_3_sys', 0)
	else:
