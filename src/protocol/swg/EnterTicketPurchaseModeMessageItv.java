...
public class EnterTicketPurchaseModeMessageItv extends SWGMessage {

	private String planetName;
	private String cityName;
	private SWGObject player;
	
	public EnterTicketPurchaseModeMessageItv(String planetName, String cityName, SWGObject player) {
	...
	public IoBuffer serialize() {
		...
		TravelPoint nearestPoint = core.travelService.getNearestTravelPoint(player, 5120);
