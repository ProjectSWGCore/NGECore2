...
public class ClientVerifyAndLockNameResponse extends UnitTest {
	...
	public boolean isValid(IoBuffer buffer) {
		...
		if (!checkString(string) || string.length() == 0 || string.contains(" ")) {
			return false;
		}
		...
		if (!checkString(string) || !string.equals("approved_flag")) {
			return false;
		}
