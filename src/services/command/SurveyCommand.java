...
public class SurveyCommand extends BaseSWGCommand {
	

	public SurveyCommand(String commandName) {
		super(commandName);
		// ToDo: check against datatables
		try {
			DatatableVisitor visitor = ClientFileManager.loadFile("datatables/crafting/component.iff", DatatableVisitor.class);
