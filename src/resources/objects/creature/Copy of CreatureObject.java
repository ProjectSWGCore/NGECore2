...
public class CreatureObject extends TangibleObject implements IPersistent {
	...
	public CreatureObject(long objectID, Planet planet, Point3D position, Quaternion orientation, String Template) {
		...
		getHamList().add(300);
		getHamList().add(0);
		getMaxHamList().add(1000);
		getMaxHamList().add(0);
		getMaxHamList().add(300);
		getMaxHamList().add(0);
		getMaxHamList().add(300);
		getMaxHamList().add(0);
	...
	public void setAccelerationMultiplierBase(float accelerationMultiplierBase) {
		notifyObservers(getBaseline(4).set("accelerationMultiplierBase", accelerationMultiplierBase), true);
	}
	...
	public void setAccelerationMultiplierMod(float accelerationMultiplierMod) {
		notifyObservers(getBaseline(4).set("accelerationMultiplierMod", accelerationMultiplierMod);, true);
	}
	...
	public void setSpeedMultiplierBase(float speedMultiplierBase) {
		notifyObservers(getBaseline(4).set("speedMultiplierBase", speedMultiplierBase);, true);
	}
	...
	public void setSpeedMultiplierMod(float speedMultiplierMod) {
		notifyObservers(getBaseline(4).set("speedMultiplierMod", speedMultiplierMod);, true);
	}
	...
	public void setListenToId(long listenToId) {
		notifyObservers(getBaseline(4).set("listenToId", listenToId);, true);
	}
	...
	public void setRunSpeed(float runSpeed) {
		notifyObservers(getBaseline(4).set("runSpeed", runSpeed);, true);
	}
	...
	public void setSlopeModAngle(float slopeModAngle) {
		notifyObservers(getBaseline(4).set("slopeModAngle", slopeModAngle), true);
	}
	...
	public void setSlopeModPercent(float slopeModPercent) {
		notifyObservers(getBaseline(4).set("slopeModPercent", slopeModPercent);, true);
	}
	...
	public void setTurnRadius(float turnRadius) {
		notifyObservers(getBaseline(4).set("turnRadius", turnRadius), true);
	}
	...
	public void setWalkSpeed(float walkSpeed) {
		notifyObservers(getBaseline(4).set("walkSpeed", walkSpeed), true);
	}
	...
	public void setWaterModPercent(float waterModPercent) {
		notifyObservers(getBaseline(4).set("waterModPercent", waterModPercent), true);
	}
	...
	public int getGuildId() {
		return (int) getBaseline(.)get("guildId");
	}
	...
	public long getTargetId() {
		return (long) getBaseline(6).get("targetId");
	}
	
	public void setTargetId(long targetId) {
		notifyObservers(getBaseline(6).set("targetId", targetId), true);
	}
	...
	public void setPerformanceId(int performanceId, boolean isDance) {
		setPerformanceId(isDance ? 0 : performanceId);
	}
