...
public class BuildingObject extends TangibleObject implements IPersistent, Serializable {
	...
	public boolean canEnter(SWGObject object) {
		return (getPrivacy() == PRIVATE && (entryList.contains(object.getObjectID()) || adminList.contains(object.getObjectID()))) || !banList.contains(object.getObjectID()) || !(NGECore.getInstance().adminService.getAccessLevelFromDB(client.getAccountId()) == null);
	}
