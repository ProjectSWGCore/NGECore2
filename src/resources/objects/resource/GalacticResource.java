...
public class GalacticResource extends SWGObject implements Serializable {
	...
	@NotPersistent
	public transient static final String [] statNamesLookup = { "Cold Resistance", "Conductivity", "Decay Resistance", "Heat Resistance", "Malleability", "Shock Resistance", "Unit Toughness", "Entangle Resistance", "Potential Energy", "Overall Quality", "Flavor" };
	...
	@NotPersistent
	// Direct Persistence Layer entity reference restriction
	...
	private void createResourceName() {
		this.name = NAME_SYLLABLE_1[(int) new Random().nextInt(NAME_SYLLABLE_1.length - 1)] + NAME_SYLLABLE_2[(int) new Random().nextInt(NAME_SYLLABLE_2.length - 1)] + NAME_SYLLABLE_3[(int) new Random().nextInt(NAME_SYLLABLE_3.length - 1)];
	}
	...
	@NotPersistent
	public final static String [] GENERAL_TYPES = { "resource_mineral", "resource_chemical", "resource_flora", "resource_gas", "resource_water", "resource_solar", "resource_wind", "resource_geothermal", "resource_tidal", "resource_hydron", "resource_bones", "resource_hide", "resource_meat", "resource_milk", "resource_JTL" };
