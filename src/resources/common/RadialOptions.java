...
public class RadialOptions {
    ...
    public static int tradeStart	= 8;
    public static int tradeAccept	= 9;
    public static int itemPickup	= 10;
    public static int itemEquip	= 11;
    public static int itemUnequip	= 12;
    public static int itemDrop	= 13;
    public static int itemDestroy	= 14;
    public static int itemToken	= 15;
    public static int itemOpen	= 16;
    public static int itemOpenNewWindow	= 17;
    public static int itemActivate	= 18;
    public static int itemDeactivate	= 19;
    public static int itemUse	= 20;
    public static int itemUseSelf	= 21;
    public static int itemUseOther	= 22;
    public static int itemSit	= 23;
    ...
    public static int missionTerminalList	= 33;
    public static int missionDetails	= 34;
